...
print("arima_6_7",score_action("arima_6_7"))
print("arima_7_6",score_action("arima_7_6"))
print("arima_7_7",score_action("arima_7_7"))
print("arima_9_9",score_action("arima_9_9"))
